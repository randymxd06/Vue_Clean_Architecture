...
export const WithoutDropdown: Story = {
  args: {
    ...
    avatarSrc: 'https://images.unsplash.com/photo-1494790108755-2616b612c3c5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
    showDropdown: false,
  },
};
...
export const GuestUser: Story = {
  args: {
    ...
    avatarSrc: 'https://images.unsplash.com/photo-1551963831-b3b1ca40c98e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
    showDropdown: true,
    menuItems: [
      { label: 'Mi Perfil', icon: 'user', action: 'profile' },
...
export const LongName: Story = {
  args: {
    ...
    avatarSrc: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
    showDropdown: true,
  },
};
