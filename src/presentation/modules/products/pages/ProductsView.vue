      ...
      <section class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <article class="space-y-2">
          ...
          <input name="name" v-model="productStore.newProduct.name"
            class="w-full px-4 py-2.5 text-sm border border-border hover:border-primary-300 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all text-text-primary placeholder:text-surface-400 bg-primary-50 rounded-lg"
        ...
        <article class="space-y-2">
          ...
          <div class="relative">
            ...
            <input name="price" v-model.number="productStore.newProduct.price" type="number" min="0" step="0.01"
              class="w-full pl-8 pr-4 py-2.5 text-sm border border-border hover:border-primary-300 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all text-text-primary placeholder:text-surface-400 bg-primary-50 rounded-lg"
