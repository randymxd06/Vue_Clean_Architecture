...
<template>
  ...
  <div class="max-w-5xl mx-auto mt-8 p-6 bg-white rounded-xl shadow-sm">
    ...
    <header class="mb-8">
      ...
      <p class="text-gray-500 mt-1">Administra el inventario de productos</p>
    </header>
    ...
    <div v-else>
      ...
      <div v-else class="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-200">
        ...
        <p class="mt-1 text-sm text-gray-500">Comienza agregando tu primer producto usando el formulario superior.</p>
        <div class="mt-6">
