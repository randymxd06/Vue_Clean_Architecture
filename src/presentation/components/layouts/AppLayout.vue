<template>
    ...
    <div class="h-screen flex bg-gray-100">
        ...
        <!--==========
            SIDEBAR
        ==============-->
        <aside class="w-64 flex flex-col bg-gray-100">
        ...
        <!--====================
            MAIN CONTENT AREA
        ========================-->
        <main class="flex-1 flex flex-col overflow-hidden pr-2 py-2">

            <!--===========================
                CONTENT CARD WITH TOPBAR
            ===============================-->
            <section class="bg-white rounded-xl shadow-sm flex-1 flex flex-col overflow-hidden">
