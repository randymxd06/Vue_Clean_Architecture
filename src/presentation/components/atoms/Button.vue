...
const variantClasses = {
  ...
  secondary: 'bg-gray-600 text-white hover:bg-gray-700 focus:ring-gray-500 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-500',
  ...
  ghost: 'bg-transparent text-gray-700 hover:bg-gray-100 focus:ring-gray-500 dark:bg-transparent dark:text-gray-300 dark:hover:bg-gray-700 dark:focus:ring-gray-500',
