<template>
  <div class="relative">
    ...
    <button
      @click="isOpen = !isOpen"
      class="flex items-center justify-center w-10 h-10 rounded-lg transition-colors duration-200 hover:bg-primary-100 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
      :class="[
        ...
        <div>
          ...
          <div class="grid grid-cols-2 gap-2">
            <button
              ...
              class="relative p-3 rounded-lg border-2 transition-all duration-200 hover:shadow-md group"
              :class="[
